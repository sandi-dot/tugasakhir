...
<!--                         <li class="nav-item hidden-sm-down search-box"> <a class="nav-link hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="{{ url('beranda') }}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('jadwal_keberangkatan') }}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Jadwal keberangkatan</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{ url('tambahdatapenumpang') }}" aria-expanded="false"><i class="mdi mdi-emoticon"></i><span class="hide-menu">Tambah penumpang</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{ url('Histori') }}" aria-expanded="false"><i class="mdi mdi-earth"></i><span class="hide-menu">Histori</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="pages-blank.html" aria-expanded="false"><i class="mdi mdi-book-open-variant"></i><span class="hide-menu">Pembatalan</span></a>
                        </li>
                        {{-- <li> <a class="waves-effect waves-dark" href="pages-error-404.html" aria-expanded="false"><i class="mdi mdi-help-circle"></i><span class="hide-menu">Bantuan</span></a>
                        </li> --}}
                    </ul>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <!-- Row -->
                        @yield('jadwal_keberangkatan')
                        @yield('Histori')
                        @yield('pembayaran')
                        @yield('tambahdatapenumpang')
                        @yield('kode_pembayaran')
                        @yield('beranda')
                            <div>
